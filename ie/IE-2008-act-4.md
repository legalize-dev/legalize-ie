...
**8**.— (1) Subject to the Data Protection Acts 1988 and 2003, the Minister may process such personal data, including biometric data, in respect of an applicant for a passport as are required for the issue of a passport to the applicant and the maintenance of the integrity of the system for issuing passports.
...
(*b*) purports to have been issued containing the data (including biometric data) that it contains by the Minister who did not in fact issue it containing those data (including biometric data), or
